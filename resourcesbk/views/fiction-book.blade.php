...
@section('content')
    ...
    <div id="butter">
        <section id="hero-6"
          class="hero-section division lazy new-inner-banner services-banner childrenbook-banner color-white"
          style="background-image:url({{asset('public/assets/images/new/friction-book/banner.png')}})">
            ...
            <div class="row d-flex align-items-center">
              <div class="col-xl-5 clo-lg-7">
                <div class="hero-6-txt white-color  mb-40 fadeInRight" data-wow-delay="0.4s">
                  <h5 class="genre-h">Fashion your <span> imagination </span> into a magically written</h5>
                  <h1 class="has-title heading-style-two">
                    fiction novel
                    <span> Let your creativity unveil</span>
                  </h1>
                  <p><b>Ghostwriting, Editing, and Launching</b> a fiction that has the potential to win hearts and take
                    readers into a whole new world</p>
                  <div class="btns-group mt-3">
                    <a href="javascript:;" class="btn btn-tra-black theme-hover last-link open_chat_btn mb-10">Talk To Our
                      Writing Consultant
                    </a>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="section-title text-center">
                    <!-- Title -->
                    <h2 class="h2-lg">What does our fiction ghost book writing service
                      involve?
                    </h2>
                  </div>
                </div>
              ...
              <div class="row text-center serv-box-Wrapper">
                ...
                <div class="col">
                  <a>
                    <div class="serv-box" data-wow-delay="0.4s">
                      <figure>
                        <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/new/children-book/icon-1.png')}}" alt="">
                      </figure>
                      <!-- Tra Digit -->
                      <!-- Text -->
                ...
                <div class="col">
                  <a>
                    <div class="serv-box" data-wow-delay="0.6s">
                      <figure>
                        <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/new/children-book/icon-2.png')}}" alt="">
                      </figure>
                      <!-- Tra Digit -->
                      <!-- Text -->
                      <div class="fbox-6-txt">
                        ...
                        <p class="p-md grey-color">Getting a fiction ghostwritten by our ghostwriters?
                          We can conceptualize, outline, write, edit, publish and even market the book
                          for you. Easy-peasy.
                        </p>
                      </div>
                ...
                <div class="col">
                  <a>
                    <div class="serv-box" data-wow-delay="0.8s">
                      <figure>
                        <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/new/children-book/icon-3.png')}}" alt="">
                      </figure>
                      <!-- Tra Digit -->
                      <!-- Text -->
                      <div class="fbox-6-txt">
                        ...
                        <p class="p-md grey-color">We can have an editing team assigned to your fiction
                          plot who can provide an independent evaluation of the book’s content and
                          recommend services to bring it closer to perfection.
                        </p>
                      </div>
                ...
                <div class="col">
                  <a>
                    <div class="serv-box" data-wow-delay="1s">
                      <figure>
                        <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/new/children-book/icon-4.png')}}" alt="">
                      </figure>
                      <!-- Tra Digit -->
                      <!-- Text -->
                      <div class="fbox-6-txt">
                ...
                <div class="col">
                  <a>
                    <div class="serv-box" data-wow-delay="1s">
                      <figure>
                        <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/new/children-book/icon-5.png')}}" alt="">
                      </figure>
                      <!-- Tra Digit -->
                      <!-- Text -->
                      <div class="fbox-6-txt">
          ...
          <div class="container">
            <div class="top">
              <div class="row">
                <div class="row">
                  <div class="col-lg-8">
                    <h2 class="h2-lg white-color">We can weave fiction storylines into an interesting book for you
                    </h2>
                    <p>Here are the fiction topics you can get a book ghostwritten on:</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="bottom">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <figure>
                    <img src="{{asset('public/assets/images/new/friction-book/book-1.png')}}" alt="">
                  </figure>
                </div>
                <div class="col-lg-3">
                  <ul>
                    ...
                    <li>Humor/ Satire</li>
                    <li>Historical fictions</li>
                    <li>Sci-fi</li>
                    <li>Flash fictions</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <section class="publish-packages">
          <div class="an-custom-container">
            <div class="section-title text-center ">
              <h2 class="h2-lg grey-color"> Our Fiction book ghostwriting <br> package includes:
              </h2>
            </div>
            <div class="row align-items-center">
                ...
                <div class="packages-mn">
                  ...
                  <div class="packges-ln">
                    <div class="packge-inn">
                      ...
                      <h6>Complete copyrights</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon13.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Editing, Proofreading, and formatting</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
              ...
              <div class="col-md-7 text-center">
                <p class="packgaes-para">** You can choose to have a package tailored in line with your ghost book writing
                  requirements.</p>
              </div>
            </div>
          </div>
