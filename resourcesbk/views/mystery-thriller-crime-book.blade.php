...
<div id="butter">
    <section id="hero-6" class="hero-section division" style="background-image: url('{{asset('public/assets/images/crime/banner.jpg')}}');">
      <!-- HERO-6 CONTENT -->
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-7">
            <div class="hero-6-txt white-color  mb-40 " data-wow-delay="0.4s">
              <!-- Title -->
              <h1 class="has-title">Create a gripping, suspense story through mystery thriller, detective or crime
                books
              </h1>
              <!-- Text -->
              <p class="p-md">Ghostwriting, editing, and publishing a thriller or crime book that will keep your
          ...
          <div class="row">
            <div class="col-md-10 ">
              <div class="section-title text-center">
                <!-- Title -->
                <h2 class="h2-lg">What does our book writing service involve?
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="0.4s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Ghostwriters who have proven years of experience in the niche are
                      assigned the task of creating a captivating story for your book with their teams.
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="0.6s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Planning to getting a thriller or crime book ghostwritten by our
                      ghostwriters? We can conceptualize, outline, write, edit, publish and even market the book for
                      you. Easy-peasy.
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="0.8s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">An expert editing team will be assigned to your genre-specific book to
                      provide an independent assessment of the book’s content and recommend services to ensure that
                      the narrative is gripping yet thrilling
                    </p>
                  </div>
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="1s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Your book is not like others, and your idea is unique; thus, we pair
                      you with a writing team that can work most closely to your book writing specifications.
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="1s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Self-publishing a book has never been easier. We can do it for you.
                      Your book will hit online stores and your target audience.
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-5 col-lg-6">
            <div class="left-column  ">
              <img class="img-fluid" src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/crime/crime-book.png')}}"
                alt="content-image">
            </div>
          </div>
          <div class="col-md-7 col-lg-6">
            <div class="txt-block right-column  grey-color">
              ...
              <!-- Section ID -->
              <!-- Title -->
              <h2 class="h2-lg grey-color">Mystery/thriller books:

              </h2>
              <!-- Text -->
              <p>
                A great mystery thriller is all about keeping your target audience guessing on what is going to happen
                next in the book. Whether it is a psychological thriller, a murder mystery or a supernatural thriller,
                our team of skilled wordsmith ensure that each chapter of the book brings forth twists and turns while
                adding suspense to the plot. Our ghostwriters will help you create a book full of captivating stories
                that are drafted in a manner to ensure your readers are hooked till the end.

              </p>
              <h2>Crime and detective books:
              </h2>
              <p>Crime books are weaved around stories based on criminal acts that seem almost impossible to solve.
                Moreover, this genre involves narratives build on thorough investigation of a specific crime such as
                murder, theft, rape and the list goes on. A few characteristics of crime stories/books include dubious
                characters and dangerous scenarios where anything can happen. A detective book is actually a subgenre
                of crime fiction where the story not only revolves around the crime but also how a detective or
                investigator inspects a crime scene - usually a murder. If you have a brilliant crime story in mind
                that you want to turn into a book, our expert team of writers and editors will help you in achieving
                your goal.
              </p>
            </div>
          </div> <!-- END TEXT BLOCK -->
    ...
    <section id="package-include" class="pt-50 pb-100  content-section division bg-grey">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-7 col-lg-6">
            <div class="txt-block right-column grey-color">
              <!-- Section ID -->
              <!-- Title -->
              <h2 class="h2-lg grey-color">Our mystery thriller and crime book ghostwriting package include:
              </h2>
              <ul>
                ...
                <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Adjusting the layout and
                  presentation for the publishing standards</li>
                <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> A dedicated team of expert
                  writers</li>
                <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Publishing navigation and
                  direct placements</li>
              ...
              <b class="color-blue">** You can choose to have a package tailored in line with your ghost book writing
                requirements. Talk to our team.
              </b>
              <!-- Text -->
            </div>
          </div> <!-- END TEXT BLOCK -->
          <div class="col-md-5 col-lg-6">
            <div class="left-column ">
              <img class="img-fluid" src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/crime/Mystery-thriller-books.png')}}"
                alt="content-image">
            </div>
          </div>
        </div> <!-- End row -->
    ...
    <div class="features-13-title bg-scroll division pt-100 pb-100">
      <div class="container">
        <div class="row">
          <!-- TITLE -->
          <div class="col-lg-11">
            <div class="features-13-txt ">
              <!-- Section ID -->
              <!-- Title -->
              <h2 class="h2-lg grey-color">Do you want to tell a story on how a criminal mind works or create suspense
                among your readers?
              </h2>
              <h4>Get your idea drafted into words – Check our book-writing guide
              </h4>
              <div class="features-13-txt ">
                <p class="p-lg">Until this point, your ghost book writing journey is like most others; however, you
                  may require more products that can help your ghostwritten book become more profitable, reach a
                  greater audience, and help create an impact on your target audience. Those are as follow:
        ...
        <div class="row audio-video">
          <div class="col-lg-6">
            <div class="features-13-txt ">
              <img src="{{asset('public/assets/images/children/audio-icon.png')}}" alt="">
              <div>
                <h4 class="h4-sm">Audio Books
                </h4>
                <p class="p-lg">Creating audiobooks that can literally narrate your crime or mystery thrillers to the
                  listeners can intrigue them way more than mere reading could do. Why make people with busy lives
                  miss out on all the fun that your ghostwritten book can offer?
          ...
          <div class="col-lg-6">
            <div class="features-13-txt ">
              <img src="{{asset('public/assets/images/children/video-icon.png')}}" alt="">
              <div>
                <h4 class="h4-sm">Video books/ Trailers

                </h4>
                <p class="p-lg">CBooks supported by visuals or videos that help the audience understand more about a
                  particular concept can go a long way. You would not want your book to just be another book that is
                  forgotten in the pages of history. Your idea can be created into a small video that your clients may
                  purchase via a subscription or as a part of your ghostwritten eBook and audio/ video book package.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-12 text-center mt-4">
            <a href="#" class="btn btn-tra-white theme-hover last-link chatOpen open_chat_btn">Talk to our
