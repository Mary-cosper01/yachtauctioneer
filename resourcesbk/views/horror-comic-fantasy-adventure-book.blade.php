...
<div id="butter">
    <section id="hero-6" class="hero-section division"
      style="background-image: url('{{asset('public/assets/images/horror-comic-fantasy-and-adventure-book-banner.jpg')}}');">
      <!-- HERO-6 CONTENT -->
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-8">
            <div class="hero-6-txt white-color pc-20 mb-40 fadeInRight" data-wow-delay="0.4s">
              ...
              <!-- Title -->
              <h1 class="has-title">Captivate your readers by weaving fascinating stories into a Horror,
                Comic, Fantasy & Adventure book
          ...
          <div class="row">
            <div class="col-md-10 ">
              <div class="section-title text-center mb-60">
                <!-- Title -->
                <h2 class="h2-lg grey-color">Our Horror, Comic, Fantasy or Adventure book writing
                  service includes
                </h2>
              </div>
            </div>
              ...
              <a href="#">
                <div class="serv-box">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Ghostwriters with proven years of experience, having
                      a command over different genres like Horror, Comic, Fantasy or Adventure,
                      are assigned the task of creating enthralling stories and turning it into an
              ...
              <a href="#">
                <div class="serv-box">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">If fantasy and adventure is a genre you want to
                      explore; or you want to get a horror story come to life through a
                      ghostwritten book; or a comic book is something you want to share with the
                      world, our ghostwriters can help you conceptualize, outline, write, edit,
                      publish and even market the book for you. Easy-peasy.
                ...
                <div class="serv-box">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">An expert editing team will be assigned to your
                      genre-specific book to provide an independent assessment of the overall
                      content. We also recommend services to ensure all the facts are accurate and
                      then further develop them into a fascinating book.
                ...
                <div class="serv-box">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">The idea and subject matter of your book is unique;
                      ...
                      idea and story but can also work closely with you and make your dream of
                      becoming an author to life.
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-5 col-lg-6">
            <div class="left-column ">
              <img class="img-fluid" src="{{asset('public/assets/images/blank-img.png')}}"
                data-src="{{asset('public/assets/images/horror-comic-fantasy-and-adventure-book.png')}}" alt="content-image">
            </div>
          </div>
          <div class="col-md-7 col-lg-6">
            <div class="txt-block right-column pc-30  grey-color">
              ...
              <!-- Section ID -->
              <!-- Title -->
              <h2 class="h2-lg grey-color">Our ghostwriting package for Horror, Comic, Fantasy and
                Adventure books includes:
                </h3>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="features-13-txt ">
              ...
              <h2 class="h2-lg grey-color">Want to make an impact through an intriguing story whether it
                is horror, comic or belongs to the fantasy and adventure genre?
              </h2>
              ...
              <div class="features-13-txt ">
                <p class="p-lg">Until this point, your ghost book writing journey is like most others;
                  however, you may require more products that can help your ghostwritten book generate
                  more profit, reach a wider audience, and help create an impact on your target
                  reader. Those are as follow:
          ...
          <div class="col-lg-6">
            <div class="features-13-txt ">
              ...
              <div>
                ...
                <p class="p-lg">Listening to horror or fantasy and adventure stories transport us to a
                  world of imagination. Creating audiobooks that can literally talk to the listeners
                  can impact your audience in a much better way that mere reading may not. Why make
                  people with busy lives miss out on the interesting and unique stories that your
                  ghostwritten book wants to put forth?
            ...
            <div class="features-13-txt ">
              ...
              <div>
                ...
                <p class="p-lg">Books that are supported by soothing visuals or helpful videos can help
                  the audience understand the idea or story better. Do you want your genre-specific
                  book to just be another book that is forgotten in the pages of history? Your idea
                  can be created into a small video that your clients may purchase via a subscription
                  or as a part of your ghostwritten eBook and audio/ video book package.
