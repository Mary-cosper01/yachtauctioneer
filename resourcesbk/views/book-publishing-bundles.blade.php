...
<section class="bundles-banner-row bundles-banner-row2">
    <div class="container">
        <div class="bundles-ban-cont aos-init aos-animate" aos="fade-up" aos-duration="1000">
            <h1>Book Publishing Bundles</h1>
        </div>
    </div>
</section>
<section class="bundles-row bundles-row2">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 aos-init aos-animate" aos="fade-right" aos-duration="1500">
                <div class="pkg-sec">
                    ...
                    <div class="pkg-flex">
                        <div class="pkg-btns">
                            <button name="499" class="btn various" title="Basic Package Only $499" data-fancybox="" data-src="#popupform" fdprocessedid="hexvnm"><a href="javascript:;">Order Now</a></button>
                        </div>
                        <div class="pkg-btns">
                            <button class="btn" fdprocessedid="oys0up"><a href="javascript:void(Tawk_API.toggle())">Live Chat</a></button>
                        </div>
                    </div>
                    <div class="info-btns">
                        <button fdprocessedid="9tdhad"><a href="tel:+14697887107">Call us at : (470) 407-7571</a></button>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 aos-init aos-animate" aos="fade-up" aos-duration="1500">
                <div class="pkg-sec">
                    ...
                    <div class="pkg-flex">
                        <div class="pkg-btns">
                            <button name="999" class="btn various" title="Startup Package Only $999" data-fancybox="" data-src="#popupform" fdprocessedid="g2mk0q"><a href="javascript:;">Order Now</a></button>
                        </div>
                        <div class="pkg-btns">
                            <button class="btn" fdprocessedid="7lq8st"><a href="javascript:void(Tawk_API.toggle())">Live Chat</a></button>
                        </div>
                    </div>
                    <div class="info-btns">
                        <button fdprocessedid="bwc677"><a href="tel:+14697887107">Call us at : (470) 407-7571</a></button>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 aos-init aos-animate" aos="fade-left" aos-duration="1500">
                <div class="pkg-sec">
                    ...
                    <div class="pkg-flex">
                        <div class="pkg-btns">
                            <button name="1,499" class="btn various" title="Standard Package Only $1,499" data-fancybox="" data-src="#popupform" fdprocessedid="6mgwbj"><a href="javascript:;">Order Now</a></button>
                        </div>
                        <div class="pkg-btns">
                            <button class="btn" fdprocessedid="ub8efc"><a href="javascript:void(Tawk_API.toggle())">Live Chat</a></button>
                        </div>
                    </div>
                    <div class="info-btns">
                        <button fdprocessedid="qgz2r9"><a href="tel:+14697887107">Call us at : (470) 407-7571</a></button>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 aos-init" aos="fade-left" aos-duration="1500">
                <div class="pkg-sec">
                    ...
                    <div class="pkg-flex">
                        <div class="pkg-btns">
                            <button name="3,999" class="btn various" title="Expert Package Only $3,999" data-fancybox="" data-src="#popupform" fdprocessedid="tndvlg"><a href="javascript:;">Order Now</a></button>
                        </div>
                        <div class="pkg-btns">
                            <button class="btn" fdprocessedid="nxnim"><a href="javascript:void(Tawk_API.toggle())">Live Chat</a></button>
                        </div>
                    </div>
                    <div class="info-btns">
                        <button fdprocessedid="dpvpq9"><a href="tel:+14697887107">Call us at : (470) 407-7571</a></button>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 aos-init" aos="fade-down" aos-duration="1500">
                <div class="pkg-sec">
                    ...
                    <ul class="list">
                        ...
                        <li>Platforms (Facebook &amp; Instagram)</li>
                        <li> 1-Year SEO (Search Engine Optimisation):</li>
                        <h4>Additional Services Includes</h4>
                        <li> 2-4 pages author website </li>
                    ...
                    <div class="pkg-flex">
                        <div class="pkg-btns">
                            <button name="6,999" class="btn various" title="Brand Package Only $6,999" data-fancybox="" data-src="#popupform" fdprocessedid="v69dcl"><a href="javascript:;">Order Now</a></button>
                        </div>
                        <div class="pkg-btns">
                            <button class="btn" fdprocessedid="73n5do"><a href="javascript:void(Tawk_API.toggle())">Live Chat</a></button>
                        </div>
                    </div>
                    <div class="info-btns">
                        <button fdprocessedid="3wnrkr"><a href="tel:+14697887107">Call us at : (470) 407-7571</a></button>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 aos-init" aos="fade-right" aos-duration="1500">
                <div class="pkg-sec">
                    ...
                    <ul class="list">
                        ...
                        <li>60-90 second book video trailer</li>
                        <li>Press Releases </li>
                    </ul>
                    <div class="pkg-flex">
                        <div class="pkg-btns">
                            <button name="11,999" class="btn various" title="Best-Seller Package Only $11,999" data-fancybox="" data-src="#popupform" fdprocessedid="kq2alb"><a href="javascript:;">Order Now</a></button>
                        </div>
                        <div class="pkg-btns">
                            <button class="btn" fdprocessedid="wsvm1"><a href="javascript:void(Tawk_API.toggle())">Live Chat</a></button>
                        </div>
                    </div>
                    <div class="info-btns">
                        <button fdprocessedid="10tz7n"><a href="tel:+14697887107">Call us at : (470) 407-7571</a></button>
                    </div>
                </div>
            </div>
        </div>
