<header id="header" class="home-menu header tra-menu navbar-light">
    ...
    <div class="header-wrapper">
      ...
      <div class="wsmobileheader clearfix">
        <span class="smllogo"><img src="{{asset('public/assets/images/blank-logobk.png')}}" data-src="{{asset('public/assets/images/logobk.png')}}" class="lazy"
      ...
      <div class="wsmainfull menu clearfix">
        <div class="wsmainwp clearfix">
          ...
          <div class="mobile-menu">
            <nav class="wsmenu clearfix">
              <ul class="wsmenu-list nav-theme-hover">
                ...
                <li aria-haspopup="true" class="has-sub-menu"><a href="#">Services <span class="wsarrow"></span></a>
          ...
          <div class="desktoplogo"><a href="{{route('home')}}" class="logo-black">
              <picture>
                <img class="img-fluid" src="{{asset('public/assets/images/logo.png')}}" data-src="{{asset('public/assets/images/logo.png')}}" alt="header-logo">
              </picture>
            </a>
            <a href="{{route('home')}}" class="logo-white">
              <picture>
                @if (!request()->segment(count(request()->segments())))
                <img class="img-fluid" src="{{asset('public/assets/images/new/logo-whitebk.png')}}" data-src="{{asset('public/assets/images/new/logo-whitebk.png')}}"
                alt="header-logo">
                @else
                <img class="img-fluid" src="{{asset('public/assets/images/logo.png')}}" data-src="{{asset('public/assets/images/logo.png')}}" alt="header-logo">
                @endif
