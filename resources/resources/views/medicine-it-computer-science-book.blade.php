...
@section('content')
    ...
    <div id="butter">
        <section id="hero-6" class="hero-section division lazy" data-src="{{asset('public/assets/images/educational-book-banner.jpg')}}">
          <!-- HERO-6 CONTENT -->
          <div class="container">
            <div class="row d-flex align-items-center">
              ...
              <div class="col-md-8">
                <div class="hero-6-txt white-color pc-20 mb-40 fadeInRight" data-wow-delay="0.4s">
                  ...
                  <!-- Title -->
                  <h1 class="has-title">Create an informative and educational book related to Medicine or IT & Computer
                    Science
                    </span>
                  </h1>
                  <!-- Text -->
                  <p class="p-md">Ghostwriting, editing, and publishing a genre-specific book made easy
                  </p>
                  <!-- Buttons Group -->
          ...
          <div class="an-custom-container">
            ...
            <div class="fbox-6-wrapper fbox-6-hover mb-60">
              <div class="row">
                <div class="col-md-10 ">
                  <div class="section-title text-center mb-60">
                    <!-- Title -->
                    <h2 class="h2-lg grey-color">Our Medicine and IT & Computer Science book writing service includes
              ...
              <div class="row text-center">
                  ...
                  <a href="#">
                    <div class="serv-box">
                      ...
                      <div class="fbox-6-txt">
                        ...
                        <p class="p-md grey-color">Ghostwriters with proven years of experience, having a command over
                          different subject matters like Medicine or IT & Computer Science, are assigned the task of
                          developing an informative book that creates awareness along with their teams.
                        </p>
                      </div>
                  ...
                  <a href="#">
                    <div class="serv-box">
                      ...
                      <div class="fbox-6-txt">
                        ...
                        <p class="p-md grey-color">Planning to get a book ghostwritten by our ghostwriters? Our team of
                          skilled writers and editors can help you conceptualize, outline, write, edit, publish and even
                    ...
                    <div class="serv-box">
                      ...
                      <div class="fbox-6-txt">
                        ...
                        <p class="p-md grey-color">An expert editing team will be assigned to your genre-specific book to
                          provide an independent assessment of the overall content. We also recommend services to ensure
                          that all the facts are accurate and then further develop them into an engaging educational book.
                        </p>
                      </div>
                  ...
                  <a href="#">
                    <div class="serv-box">
                      ...
                      <div class="fbox-6-txt">
                        ...
                        <p class="p-md grey-color">The idea and subject matter of your book is unique; hence we connect
                          you to a ghostwriting team that not only understands your idea but can also work closely with
                          you and make your dream of becoming an author to life.
                        </p>
                      </div>
                ...
                <div class="col-md-12">
                  <p class="text-center"><b class="color-blue">**All of the books can be supported by illustrations and
                      pictures
                    </b></p>
                </div>
              </div> <!-- End row -->
            ...
            <div class="row d-flex align-items-center">
              ...
              <div class="col-md-7 col-lg-6">
                <div class="txt-block right-column pc-30  grey-color">
                  ...
                  <!-- Section ID -->
                  <!-- Title -->
                  <h2 class="h2-lg grey-color">Our ghostwriting package for Medicine and IT & Computer Science books
                    includes:
                    ...
                    <b class="color-blue">** You can choose to have a package customized as per your ghost book writing
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="features-13-txt ">
                  <!-- Section ID -->
                  <!-- Title -->
                  <h2 class="h2-lg grey-color">
                  </h2>
                  <h2 class="h2-lg grey-color">Want to make an impact and educate the masses regarding medicinal
                    innovations or IT & Computer Science?
                  ...
                  <div class="features-13-txt ">
                    <p class="p-lg">Until this point, your ghost book writing journey is like most others; however, you
                      may require more products that can help your ghostwritten book generate more profit, reach a wider
                      audience, and help create an impact on your target reader. Those are as follow:
                    </p>
                  </div>
              ...
              <div class="col-lg-6">
                <div class="features-13-txt ">
                  ...
                  <div>
                    ...
                    <p class="p-lg">Creating audiobooks that can literally talk to the listeners can impact your audience
                      in a much better way that mere reading may not. Why make people with busy lives miss out on the
                      interesting and unique innovations that your ghostwritten book wants to put forth?
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="features-13-txt ">
                  ...
                  <div>
                    ...
                    <p class="p-lg">Books that are supported by visuals or helpful videos can help the audience understand
                      the idea or story better. Do you want your genre-specific book to just be another book that is
