...
@section('content')
    ...
    <div id="butter">
        <section id="hero-6" class="hero-section division lazy new-inner-banner services-banner audio-banner"
          data-src="{{asset('public/assets/images/new/audio-book/banner.jpg')}}">
          <!-- HERO-6 CONTENT -->
            ...
            <div class="row d-flex align-items-center">
              ...
              <div class="col-lg-5">
                <div class="hero-6-txt white-color  mb-40 fadeInRight" data-wow-delay="0.4s">
                  ...
                  <!-- Title -->
                  <h1 class="has-title">Audio Book
                  </h1>
                  <h6>Write, finalize, and narrate.</h6>
                  <p>This is how simple getting an audiobook done is. Why do people seek our help to have their <b>
                      audiobooks </b> completed?</p>
                  <!-- Text -->
                  <div class="btns-group">
                    <a href="javascript:;" class="btn btn-theme tra-black-hover  chatOpen open_chat_btn mb-10">Schedule a
                      free
                      consultation
                    </a>
                  </div>
        ...
        <!-- Title -->
        <section class="audio-book-section-1">
          <div class="container">
            <div class="row">
              <div class="col-lg-6">
                <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/new/audio-book/1.jpg')}}" alt="">
              </div>
              <div class="col-lg-6">
                <h2 class="h2-lg grey-color">Audio Book
                </h2>
                <h5>Write, finalize, and narrate. </h5>
                <p>
                  This is how simple getting an audiobook done is. Why do people seek our help to have their audiobooks
                  completed? We have an in-house team of native narrators whose voice is captivating and in line with what
                  the target audience would want to hear. Having one of the best book audio narrators for hire, even if
                  you want to get your book narrated in a different language, we can have that done as well. Talk to our
                  sales strategists and select the voice that delivers your message the best.</p>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-6">
                <h2 class="h2-lg grey-color">
                  Choose an audiobook narration style that suits your ghostwritten book the best.
                </h2>
                <h5>US
                  ghostwriting offers the following:</h5>
                <ul class="icons-ul">
                  <li>
                    <div>
                      <img src="{{asset('public/assets/images/new/audio-book/icon-1.png')}}" alt="">
                    </div> Multicast
                  </li>
                  <li>
                    <div>
                      <img src="{{asset('public/assets/images/new/audio-book/icon-2.png')}}" alt="">
                    </div> Gilbert
                  </li>
                  <li>
                    <div>
                      <img src="{{asset('public/assets/images/new/audio-book/icon-3.png')}}" alt="">
                    </div> Duet narration
                  </li>
                  <li>
                    <div>
                      <img src="{{asset('public/assets/images/new/audio-book/icon-4.png')}}" alt="">
                    </div> Full-cast
                  </li>
                </ul>
              </div>
              <div class="col-lg-6">
                <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/new/audio-book/2.jpg')}}" alt="">
              </div>
              <div class="col-md-9 bottom text-center">
                <p> <b>
                    Choose which audiobook narration suits your book the best, select an
                    audiobook narrator for hire and witness your book materializing into its best audio version.
                  </b>
                </p>
                <a href="javascript:;" class="btn btn-tra-black theme-hover last-link open_chat_btn mb-10">Talk
                  to us
                </a>
              </div>
            </div>
