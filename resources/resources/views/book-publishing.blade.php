...
@section('content')
    <style>
     ...
     <div id="butter">
        <section id="hero-6"
          class="hero-section division lazy new-inner-banner services-banner bookmarketing-banner  color-white"
          data-src="{{asset('public/assets/images/new/book-publishing/banner.jpg')}}">
          <div class="an-custom-container">
            <div class="row d-flex align-items-center">
              <div class="col-xl-5 col-lg-7">
                <div class="hero-6-txt white-color  mb-40 fadeInRight" data-wow-delay="0.4s">
                  <h4>AFFORDABLE BOOK PUBLISHING</h4>
                  <h1 class="has-title">Do you have your manuscript ready? Let’s Publish
                  </h1>
                  <p>Book self publishing company, After having a book ghostwritten and/or ghost edited, it’s time to <b
                      class="yellow">unveil</b> your
                    book in front of the world.</p>
        ...
        <section class="publishingservices">
          <div class="container">
            <div class="section-title text-center ">
              <h2 class="h2-lg grey-color">Publishing Services
              </h2>
              <p>The Publishing process is simple. Let’s say that you are publishing the book on Amazon
              </p>
            </div>
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="publish-txt">
                  <h4>End-to-End Publisher Support</h4>
                  <p>We take care of the publishing hassle on your behalf. If you want us to publish your book for you,
                    rest assured, from formatting to getting it live, we take care of it all. (This includes beta-reader
                    editing, proofreading,
                    and typesetting)</p>
                </div>
              </div>
              <div class="col-md-6">
                <img src="{{asset('public/assets/images/new/book-publishing/img1.jpg')}}" class="img-fluid" alt="">
              </div>
            </div>
            <div class="row align-items-center zig-zag-2">
              <div class="col-md-6">
                <div class="publish-txt">
                  <h4>Publishing Navigation</h4>
                  <p>We target the platform which can gather the highest number of audiences for the genre you have
                    written your book in. This helps in gathering a greater audience and can also devise a marketing
                    strategy likewise if you’d
                    like.
                  </p>
                </div>
              </div>
              <div class="col-md-6">
                <img src="{{asset('public/assets/images/new/book-publishing/img2.jpg')}}" class="img-fluid" alt="">
              </div>
            </div>
            <div class="row align-items-center zig-zag-3">
              <div class="col-md-6">
                <div class="publish-txt">
                  <h4>Cover Designing</h4>
                  <p>We take care of the publishing hassle on your behalf. If you want us to publish your book for you,
                    rest assured, from formatting to getting it live, we take care of it all. (This includes beta-reader
                    editing, proofreading,
                    and typesetting)</p>
              ...
              <div class="col-md-6">
                <img src="{{asset('public/assets/images/new/book-publishing/img3.jpg')}}" class="img-fluid" alt="">
              </div>
            </div>
            <div class="row align-items-center zig-zag-4">
              <div class="col-md-6">
                <div class="publish-txt">
                  <h4>Publishing</h4>
                  <p>In case you have a website, the shop plug-in is integrated, and the books are uploaded on the website
                    just like any e-commerce store would sell its products. However, if the books are being published on
                    third-party platforms,
                    specific protocols are followed.</p>
                </div>
              </div>
              <div class="col-md-6">
                <img src="{{asset('public/assets/images/new/book-publishing/img4.jpg')}}" class="img-fluid" alt="">
              </div>
            ...
            <div class="col-md-12 text-center">
              <div class="publish-btn">
                <div class="btn-wrap-group text-center mt-4">
                  <a href="javascript:;" class="btn btn-theme tra-black-hover quotePopup mb-10">Schedule a free
                    consultation
                  </a>
        ...
        <section class="publish-packages">
          <div class="an-custom-container">
            <div class="section-title text-center ">
              <h2 class="h2-lg grey-color"> Our book publishing package includes:
              </h2>
            </div>
  
            <div class="row align-items-center">
              <div class="col-lg-5">
                <div class="p-package-book">
                  <img src="{{asset('public/assets/images/new/book-publishing/side-image.png')}}" class="img-fluid" alt="">
                </div>
              </div>
              <div class="col-lg-7">
                <div class="packages-mn">
                  <div class="packges-ln">
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon1.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Book Formatting</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon2.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Tailored Book interiors</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon3.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Thought-provoking title</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon4.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Amazon tags and descriptions</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon5.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Tailored product description</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon6.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Press Release writing</h6>
                    </div>
                  </div>
                  <div class="packges-ln">
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon7.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Expert Line Editors</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon8.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Unlimited revisions</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon9.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Publishing platforms </h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon10.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>Access to the online portal</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon11.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>100% Ownership Rights</h6>
                    </div>
                    <div class="packge-inn">
                      <figure>
                        <img src="{{asset('public/assets/images/new/book-publishing/icon12.png')}}" class="img-fluid" alt="">
                      </figure>
                      <h6>100% Content Copyrights</h6>
                    </div>
                  </div>
              ...
              <div class="col-md-9 text-center">
                <p class="packgaes-para">** You can choose to have a package tailored in line with your ghost book
                  publishing requirements. Talk to our team.</p>
              </div>
            </div>
          </div>
        </section>
  
        <section class="publish-process">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <div class="section-title text-center ">
                  <h2 class="h2-lg grey-color"> The book publishing process
                  </h2>
                  <p>The Publishing process is simple. Let’s say that you are publishing the book on Amazon. The customer
                    has to provide a registered Amazon account that is linked to their phone. In the case they do not have
                    one, our publishing
                    representative can help them set up one. Once set up, the customers have to update their information
                    (they can seek the publishing department’s help if they are comfortable in having someone else put
                    their personal
                    information for them).
                  </p>
                  <p>
                    Once the email and passwords are shared, the publisher and the customer have to agree on a scheduled
                    virtual meeting time when the publisher would access all accounts for the relevant publishing
                    platforms. Usually, an OTP or email notification is sent
                    to the registered email address and number that requires approval within 60 seconds; hence, the client
                    is always advised to be available via call. This process is true for the following platforms:</p>
                </div>
                <div class="logo-sec">
                  <ul>
                    <li><img src="{{asset('public/assets/images/new/book-publishing/logo1.png')}}" class="img-fluid" alt=""></li>
                    <li><img src="{{asset('public/assets/images/new/book-publishing/logo2.png')}}" class="img-fluid" alt=""></li>
                    <li><img src="{{asset('public/assets/images/new/book-publishing/logo3.png')}}" class="img-fluid" alt=""></li>
                    <li><img src="{{asset('public/assets/images/new/book-publishing/logo4.png')}}" class="img-fluid" alt=""></li>
                    <li><img src="{{asset('public/assets/images/new/book-publishing/logo5.png')}}" class="img-fluid" alt=""></li>
                  </ul>
                  <div class="talk-btn">
                    <a href="javascript:;" class="btn btn-tra-black theme-hover last-link open_chat_btn mb-10">Talk to us
                    </a></div>
