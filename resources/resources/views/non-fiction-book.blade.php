...
@section('content')
    ...
    <div id="butter">
        <section id="hero-6" class="hero-section division"
          style="background-image: url('{{asset('public/assets/images/non-fiction-book-banner.jpg')}}');">
          <!-- HERO-6 CONTENT -->
          <div class="container">
            <div class="row d-flex align-items-center">
              ...
              <div class="col-md-8">
                <div class="hero-6-txt white-color  mb-40 " data-wow-delay="0.4s">
                  ...
                  <!-- Title -->
                  <h1 class="has-title">Pen a flawless <span> non-fiction book </span> and share your message with the
                    world
  
                  </h1>
                  <!-- Text -->
                  <p class="p-md">Ghostwriting, editing, and launching non-fiction that has the potential to become a
                    success
                  </p>
                  <!-- Buttons Group -->
              ...
              <div class="row">
                <div class="col-md-10 ">
                  <div class="section-title text-center">
                    <!-- Title -->
                    <h2 class="h2-lg">What does our <span> non-fiction ghost book </span> writing service involve?
                  ...
                  <a href="#">
                    <div class="serv-box" data-wow-delay="0.6s">
                      ...
                      <div class="fbox-6-txt">
                        ...
                        <p class="p-md grey-color">Getting non-fiction ghostwritten by our ghostwriters? We can
                          conceptualize, outline, write, edit, publish and even market the book for you. Easy-peasy.
                        </p>
                      </div>
                  ...
                  <a href="#">
                    <div class="serv-box" data-wow-delay="0.8s">
                      ...
                      <div class="fbox-6-txt">
                        ...
                        <p class="p-md grey-color">We can have an editing team assigned to your non-fiction plot who can
                          provide an independent evaluation of the book’s content and recommend services to bring it
            ...
            <div class="row d-flex align-items-center">
              <div class="col-md-5 col-lg-6">
                <div class="left-column  ">
                  <img class="img-fluid" src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/non-fiction-book-01.png')}}"
                    alt="content-image">
                </div>
              </div>
              <div class="col-md-7 col-lg-6">
                <div class="txt-block right-column  grey-color">
                  ...
                  <!-- Section ID -->
                  <!-- Title -->
                  <h2 class="h2-lg grey-color">We can weave fiction and non-fiction storylines into an interesting book
                    for you
  
                  </h2>
                  <p>Here are the non-fiction topics you can get a book ghostwritten on:
  
                  </p>
                  <!-- Text -->
                  <ul>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> to-dos/ How-tos </li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Journals</li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Politics</li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Love/ Poetry</li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Informative</li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Textbooks </li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Essays/ Guides </li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Historical non-fictions </li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Personal Financing </li>
                    <li> <img src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/check.png')}}" alt=""> Textbooks/ Educational </li>
                  </ul>
            ...
            <div class="row d-flex align-items-center">
              <div class="col-md-7 col-lg-6">
                <div class="txt-block right-column  grey-color">
                  ...
                  <!-- Section ID -->
                  <!-- Title -->
                  <h2 class="h2-lg grey-color">Our Non-fiction book ghostwriting package includes:
              ...
              <div class="col-md-5 col-lg-6">
                <div class="left-column ">
                  <img class="img-fluid" src="{{asset('public/assets/images/blank-img.png')}}" data-src="{{asset('public/assets/images/non-fiction-book-02.png')}}"
                    alt="content-image">
                </div>
              </div>
