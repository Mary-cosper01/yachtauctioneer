...
<div id="butter">
    <section id="hero-6" class="hero-section division"
      style="background-image: url('{{asset('public/assets/images//business-book-banner.jpg')}}');">
      <!-- HERO-6 CONTENT -->
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-7">
            <div class="hero-6-txt white-color  mb-40 " data-wow-delay="0.4s">
              ...
              <!-- Title -->
              <h4>BUSINESS BOOK GHOSTWRITER</h4>
              <h1 class="has-title">A powerful <span> Business book </span> to establish yourself as an
                expert in your field

              </h1>
              <!-- Text -->
              <p class="p-md">Looking for a business book ghostwriter? Ghostwriting, editing, and publishing your
                Business book made easy
          ...
          <div class="row">
            <div class="col-md-10 ">
              <div class="section-title text-center">
                <!-- Title -->
                <h2 class="h2-lg">Our <span> business book </span> writing service includes
                </h2>
              </div>
            </div>
          </div>
                ...
                <div class="serv-box" data-wow-delay="0.4s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Ghostwriters with proven years of experience in the
                      ...
                      engaging book along with their teams.
                    </p>
                  </div>
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="0.6s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Planning to get a business book ghostwritten by our
                      ghostwriters? We can help you conceptualize, outline, write, edit, publish
                      and even market the book for you. Easy-peasy.
                ...
                <div class="serv-box" data-wow-delay="0.8s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">An expert editing team will be assigned to your
                      business book to provide an independent assessment of the book’s content and
                      recommend services to ensure accuracy.
                ...
                <div class="serv-box" data-wow-delay="1s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">The idea and subject matter of your book is unique;
                      ...
                      views but can also work closely to meet your book writing requirements.
        ...
        <div class="row d-flex align-items-center">
          <div class="col-md-5 col-lg-6">
            <div class="left-column  ">
              <img class="img-fluid" src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//business-book.png')}}"
                alt="content-image">
            </div>
          </div>
          <div class="col-md-7 col-lg-6">
            <div class="txt-block right-column  grey-color">
              ...
              <!-- Section ID -->
              <!-- Title -->
              <h2 class="h2-lg grey-color">We can weave accurate facts and stats into <span> business
                  books </span> for you
              </h2>
              <p>Here are some topics you can get a business book ghostwritten on:
              </p>
              <!-- Text -->
              <ul>
                <li> <img src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//check.png')}}" alt=""> Starting a business from
                  scratch</li>
                <li> <img src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//check.png')}}" alt=""> Ways to expand your business
                </li>
                <li> <img src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//check.png')}}" alt=""> Books on economics</li>
                <li> <img src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//check.png')}}" alt=""> Leadership books</li>
                <li> <img src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//check.png')}}" alt=""> Books on management</li>
                <li> <img src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//check.png')}}" alt=""> Business marketing books</li>
                <li> <img src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//check.png')}}" alt=""> Guide to becoming a
                  successful entrepreneur
                </li>
              </ul>
              <b class="color-blue">**All of the books can be supported by illustrations and pictures
              </b>
            </div>
          </div> <!-- END TEXT BLOCK -->
    ...
    <section id="package-include" class="pt-50 pb-100  content-section division bg-grey mob-row-reverse">
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-7 col-lg-6">
            <div class="txt-block right-column  grey-color">
              ...
              <!-- Section ID -->
              <!-- Title -->
              <h2 class="h2-lg grey-color">Our ghostwriting package for <span> Business books </span>
                includes:
              ...
              <b class="color-blue">** You can choose to have a package customized in line with your ghost
                book writing requirements. Talk to our team.
              </b>
            </div>
          </div> <!-- END TEXT BLOCK -->
          <div class="col-md-5 col-lg-6">
            <div class="left-column ">
              <img class="img-fluid" src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//Business-book-02.png')}}"
                alt="content-image">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-11">
            <div class="features-13-txt ">
              <!-- Section ID -->
              <!-- Title -->
              <h2 class="h2-lg grey-color">Want to guide the future generations on how to start a
                business?
              </h2>
              ...
              <div class="features-13-txt ">
                <p class="p-lg">Until this point, your ghost book writing journey is like most others;
                  however, you may require more services that can help your ghostwritten book generate
                  more profit, reach a wider audience, and help create an impact on your target
                  market. Those are as follow:
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row audio-video">
          <div class="col-lg-6">
            <div class="features-13-txt ">
              ...
              <div>
                ...
                <p class="p-lg">Business books are guides that provide first-hand knowledge about their
                  experiences of starting a business or expanding it and how they overcame it.
                  Creating audiobooks that can literally talk to the listeners can impact in a much
                  better way that mere reading may not. Why make people who want to do something big
                  in their lives miss out on the message that your ghostwritten book wants to put
                  forth?
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="features-13-txt ">
              ...
              <div>
                <h4 class="h4-sm">Tutorial Videos
                </h4>
                <p class="p-lg">A book that is supported by visuals or helpful tutorial videos can help
                  the audience to better understand the concept and go a long way in making an impact
                  on budding business persons. You would not want your book to just be another book
                  that is forgotten in the pages of history. Your idea can be created into a small
                  tutorial video that your readers may purchase via a subscription or as a part of
                  your ghostwritten eBook and audio/ video book package.
                </p>
              </div>
            </div>
          </div>
