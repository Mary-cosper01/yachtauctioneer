...
@section('content')
    ...
    <div id="butter">
        <section id="hero-6"
          class="hero-section division lazy new-inner-banner services-banner bookcoverdesign-banner color-white center"
          data-src="{{asset('public/assets/images/new/cover-design/banner.jpg')}}">
          <div class="an-custom-container">
            <div class="row d-flex align-items-center">
              <div class="col-lg-7">
                <div class="hero-6-txt white-color  mb-40 fadeInRight" data-wow-delay="0.4s">
                  <h1 class="has-title">Cover Design
                  </h1>
                  <p>Let your aesthetic book cover be a gateway to your book. <br>
                    Let’s be real people are drawn to your book based on its appearance.</p>
                  <div class="btns-group mt-3">
                    <a href="javascript:;"
                      class="btn btn-tra-white theme-hover last-link chatOpen open_chat_btn mb-10">Schedule a free
                      consultation
                    </a>
                  </div>
                </div>
        ...
        <!-- Title -->
        <section class="cover-design-section-1">
          <div class="container">
            <div class="row">
              <div class="col-lg-11">
                <div class="section-title text-center ">
                  <h2 class="h2-lg grey-color">Cover designing
                  </h2>
                  <p>Let our expert book cover designers design a spectacular cover that goes well with
                    the
                    theme and genre of your book. Your cover has the power to create an everlasting impression. Let us
                    design a
                    professional book cover for your book. Did you know that a cover plays a significant role in your
                    marketing
                    strategy?
                  </p>
                </div>
            ...
            <div class="row bottom">
              <div class="col-md-6 left">
                <div class="section-title ">
                  <h2 class="h2-lg grey-color">What does a book Cover entail?
                  </h2>
                  <p>A book cover has to be very attractive. It is not important if the book is lying in stores or online.
                    It has to captivate the audience. So, what do you need to provide to us for a spectacular book cover?
                  </p>
                </div>
                <div class="cover-item">
                  <figure>
                    <img src="{{asset('public/assets/images/new/cover-design/c-1.jpg')}}" alt="">
                  </figure>
                  <h5>Author’s Name</h5>
                </div>
                <div class="cover-item">
                  <figure>
                    <img src="{{asset('public/assets/images/new/cover-design/c-2.jpg')}}" alt="">
                  </figure>
                  <h5>About The Author</h5>
                </div>
                <div class="cover-item">
                  <p>Choose which audiobook narration suits your book the best, select an audiobook narrator for hire and
                    witness your book materializing into its best audio version.</p>
                </div>
                <a href="javascript:;" class="btn btn-tra-white theme-hover last-link chatOpen open_chat_btn mb-10">Talk
                  To Us Strategies
                </a>
              </div>
              ...
              <div class="col-md-5">
                <div class="cover-item">
                  <figure>
                    <img src="{{asset('public/assets/images/new/cover-design/c-3.jpg')}}" alt="">
                  </figure>
                  <h5>The Title</h5>
                </div>
                <div class="cover-item">
                  <figure>
                    <img src="{{asset('public/assets/images/new/cover-design/c-4.jpg')}}" alt="">
                  </figure>
                  <h5>Preface</h5>
                </div>
                <div class="cover-item">
                  <figure>
                    <img src="{{asset('public/assets/images/new/cover-design/c-5.jpg')}}" alt="">
                  </figure>
                  <h5>Author’s Photo</h5>
                </div>
              </div>
            </div>
          </div>
