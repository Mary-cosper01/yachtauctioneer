...
@section('content')
    ...
    <div id="butter">
        <section id="hero-6"
          class="hero-section division lazy new-inner-banner services-banner bookcoverdesign-banner color-white "
          data-src="{{asset('public/assets/images/new/website/banner.jpg')}}">
          <div class="an-custom-container">
            <div class="row d-flex align-items-center">
              <div class="col-lg-5">
                <div class="hero-6-txt white-color  mb-40 fadeInRight" data-wow-delay="0.4s">
                  <h1 class="has-title">Author’s Website
                  </h1>
                  <strong class="neon">Do you trust people or brands without an online presence?</strong>
                  <p>This is why you would also need one before you launch your <b class="pink"> book. </b></p>
                  <div class="btns-group mt-3">
                    <a href="javascript:;" class="btn btn-theme  last-link chatOpen open_chat_btn mb-10">Schedule a free
                      consultation
                    </a>
                  </div>
                </div>
        ...
        <!-- Title -->
        <section class="website-section-1">
          <div class="container">
            <div class="section-title text-center">
              <h2 class="h2-lg grey-color">Author’s Website
              </h2>
  
              <p>While it is not a mandatory requirement to publish a book, it is a way to keep all of the royalty
                payments yourself, rather than paying a handsome chunk of it to a third-party platform. An author’s
                website can be tailored as per your requirements and your budget. Talk to our sales strategists to find
            ...
            <div class="web-portfolio">
              <div class="row">
                <div class="col-md-6">
                  <div class="web-portfolio-item">
                    <a href="{{asset('public/assets/images/new/website/img-1.jpg')}}">
                      <img src="{{asset('public/assets/images/new/website/img-1.jpg')}}" alt="">
                    </a>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="web-portfolio-item">
                    <a href="{{asset('public/assets/images/new/website/img-2.jpg')}}">
                      <img src="{{asset('public/assets/images/new/website/img-2.jpg')}}" alt="">
                    </a>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="web-portfolio-item">
                    <a href="{{asset('public/assets/images/new/website/img-3.jpg')}}">
                      <img src="{{asset('public/assets/images/new/website/img-3.jpg')}}" alt="">
                    </a>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="web-portfolio-item">
                    <a href="{{asset('public/assets/images/new/website/img-4.jpg')}}">
                      <img src="{{asset('public/assets/images/new/website/img-4.jpg')}}" alt="">
                    </a>
                  </div>
                </div>
                <div class="btn-wrap-group col-lg-12 text-center mt-4">
                  <a href="javascript:;" class="btn btn-tra-black theme-hover last-link open_chat_btn mb-10">Talk to
                    us</a>
                </div>
              </div>
            </div>
