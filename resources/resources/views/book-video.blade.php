    ...
    <style>
        ...
        <div id="butter">
            <section id="hero-6"
              ...
              data-src="{{asset('public/assets/images/new/video-t/banner.jpg')}}">
              <div class="an-custom-container">
                <div class="row d-flex align-items-center">
                  <div class="col-lg-5">
                    <div class="hero-6-txt white-color  mb-40 fadeInRight" data-wow-delay="0.4s">
                      <h1 class="has-title">Book Trailer and Videos
                      </h1>
                      <p>A book supported by <b class="yellow"> visuals </b> would also attract people who are rather not a <b
                          class="pink"> “book person” </b> Helping you tap market gaps; you can even create a celebrity
                        profile via video bundles.</p>
            ...
            <section class="video-section-1">
              <div class="container">
                <div class="section-title text-center">
                  <h2 class="h2-lg grey-color">Book Trailer and Videos
                  </h2>
                  <p>If you are not someone who would
                    want to create a lot of video content, you can go with a book trailer that is a glimpse of your book, just
                    like a movie trailer is a glimpse of the movie.
                  </p>
                </div>
                <div class="row">
                  <div class="col-lg-4 col-md-6">
                    <div class="video-box">
                      <figure>
                        <img src="{{asset('public/assets/images/new/video-t/video-1.jpg')}}" alt="">
                      </figure>
                      <h5>Book Trailer and Videos</h5>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                    <div class="video-box">
                      <figure>
                        <img src="{{asset('public/assets/images/new/video-t/video-2.jpg')}}" alt="">
                      </figure>
                      <h5>Book Trailer and Videos</h5>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                    <div class="video-box">
                      <figure>
                        <img src="{{asset('public/assets/images/new/video-t/video-3.jpg')}}" alt="">
                      </figure>
                      <h5>Book Trailer and Videos</h5>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                    <div class="video-box">
                      <figure>
                        <img src="{{asset('public/assets/images/new/video-t/video-4.jpg')}}" alt="">
                      </figure>
                      <h5>Book Trailer and Videos</h5>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                    <div class="video-box">
                      <figure>
                        <img src="{{asset('public/assets/images/new/video-t/video-5.jpg')}}" alt="">
                      </figure>
                      <h5>Book Trailer and Videos</h5>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                    <div class="video-box">
                      <figure>
                        <img src="{{asset('public/assets/images/new/video-t/video-6.jpg')}}" alt="">
                      </figure>
                      <h5>Book Trailer and Videos</h5>
                    </div>
                  </div>
