...
<div id="butter">
    <section id="hero-6" class="hero-section division lazy" data-src="{{asset('public/assets/images//book-marketing/Cook-Book.jpg')}}">
      <!-- HERO-6 CONTENT -->
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-7">
            <div class="hero-6-txt white-color  mb-40 fadeInRight" data-wow-delay="0.4s">
              ...
              <!-- Title -->
              <h1 class="has-title">A <span> cookbook </span> full of scrumptious recipes, adding some flavor to life

              </h1>
              <!-- Text -->
              <p class="p-md">Ghostwriting, editing, and publishing your cookbook made easy
              </p>
              <!-- Buttons Group -->
    ...
    <div id="brands-1" class="brands-section division platforms">
      <div class="container">
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-10 ">
              <div class="section-title text-center">
                <!-- Title -->
                <h2 class="h2-lg">What does our <span> cookbook </span> writing service involve?
                </h2>
              </div>
            </div>
          </div>
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="0.4s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Ghostwriters with proven years of experience in the niche are assigned
                      the task of turning your mouthwatering recipes into an appealing and interesting cookbook with
                      the help of their teams. Not only will the cookbook contain important information about
                      different cuisines but will also include properties of different ingredients, quick fixes and
                      much more.
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="0.6s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Planning to get a cookbook ghostwritten by our ghostwriters? We can
                      help you conceptualize, outline, write, edit, publish and even market the book for you.
                      Easy-peasy.
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="0.8s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">An expert editing team will be assigned to your cookbook to evaluate
                      and assess whether the dishes and recipes are compiled according to your requirements as well as
                      make sure that all the details are accurate. Besides, we are extra cautious that each step of
                      the recipes is clear for the readers to grasp easily.
                    </p>
                  </div>
              ...
              <a href="#">
                <div class="serv-box" data-wow-delay="1s">
                  ...
                  <div class="fbox-6-txt">
                    ...
                    <p class="p-md grey-color">Your cookbook is unique because you have created different recipes by
                      experimenting and adding different ingredients; hence we connect you to a skilled ghostwriting
                      team that understands what cooking is all about and also works closely with you to meet your
                      cookbook needs.
                    </p>
                  </div>
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          <div class="col-md-5 col-lg-6">
            <div class="left-column fadeInLeft" data-wow-delay="0.4s">
              <img class="img-fluid" src="{{asset('public/assets/images//blank-img.png')}}" data-src="{{asset('public/assets/images//book-marketing/Cookbook-01.png')}}"
                alt="content-image">
            </div>
          </div>
          <div class="col-md-7 col-lg-6">
            <div class="txt-block right-column fadeInRight grey-color" data-wow-delay="0.4s">

              <!-- Section ID -->
              <!-- Title -->
              <h2 class="h2-lg grey-color">Our ghostwriting package for Cookbook includes:</h2>
              ...
              <b class="color-blue">** You can choose to have a package customized in line with your ghost book
                                ...
                                <div>
                                    ...
                                    <div class="back">
                                        ...
                                        <a data-fancybox data-src="#Fantasy-popup4"
                                            class="btn btn-tra-black theme-hover mb-10" href="javascript:;">View More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
